\subsection{Dynamiske side af analysen}
Figure \ref{fig:OpretSag} viser hvad gruppen havde tænkt der skal ske når en sagsbehandler eller sekræter opretter en sag i systemmet.
