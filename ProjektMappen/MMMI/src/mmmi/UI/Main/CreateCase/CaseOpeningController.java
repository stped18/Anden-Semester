...
public class CaseOpeningController implements Initializable {
    ...
    @FXML
    private TextArea fxTA_RegardingInquiry, fxRB_agreeToInquiryYesRegarding, fxRB_offerWithAuthority,
            fxRB_outgoingOffer, fxRB_agreeToInquiryNo1Regarding, fxRB_agreeToInquiryYesRequesting,
    ...
    private ToggleGroup tgLookingForGroup, carriageTG, treatmentTG,
            otherElementTG, controlTG, controlBenefitTG, stayTG, socialPedagogicalHelpTG,
            personalHelpSchemeTG;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        tgLookingForGroup = carriageTG = treatmentTG
                = otherElementTG = controlTG = controlBenefitTG = stayTG = socialPedagogicalHelpTG
                = personalHelpSchemeTG = new ToggleGroup();
